import newmod
from newmod import Guest, Party, session
import csv


def load_guests(sesh):
    with open('dbs/guests.csv', 'rU') as csvfile:
...
def load_parties(sesh):
    with open('dbs/parties.csv', 'rU') as csvfile:
